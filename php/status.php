...
<body class="fondo4">
	...
	<div class="row">
		...
		<form class="form-register-status col-lg-8"method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		    ...
		    <div class="row">
				<button type="submit" class=" btn btn-primary col-lg-2" name="submit">Rastrear pedido</button>
				<div class="col-lg-1"></div>
				<?php if ($varsesion == 'admin') {
					echo "<button type=\"submit\" class=\" btn btn-primary col-lg-2\" name=\"estado\">Estado siguiente</button>";
				} ?>
		    </div>
		</form>
		<div class="col-lg-2"></div>
